 ...
 * ============================================================================
 *
 * <p>This class extends {@link Application} and serves as the entry point
 * for application-wide initialization. It is instantiated ONCE when the
 * app process starts, before any Activity or Service is created.</p>
 *
 * <p><b>Registered in AndroidManifest.xml:</b>
 * {@code android:name=".SmartWardrobeApplication"}</p>
 *
...
public class SmartWardrobeApplication extends Application {
     ...
     *
     * <p>We initialize the database here to:
     * <ol>
